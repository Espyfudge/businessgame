...
//@author Rutger
// screen for the fifth playable level
class Level5 extends Screen
{
	...
	override public function onLoad():Void
	{
		...
		var backData : BitmapData = Assets.getBitmapData( "assets/BackgroundLevelFive.png" );
	...
	public function update(e:Event)
	{
		...
		if ( enemyCount == enemyAmount && rEnemyCount == rEnemyAmount && enemy.length == 0 && rollEnemy.length == 0 ) {
			...
			if (elvCount == 120 ) {	
				...
				deleteLevel();
				Main.sm.changeScreen(ScreenType.Win);
