...
@:keep @:bind #if display private #end class __ASSET__assets_charactersheet_xml extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_enemysheet_xml extends flash.utils.ByteArray { }
